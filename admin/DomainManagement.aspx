<%@ page language="C#" masterpagefile="~/admin/MasterPage.master" autoeventwireup="true" inherits="admin_DomainManager, App_Web_n0pp6tlb" title="Shubh Client Panel :: Admin" %>
    ...
    <asp:Panel ID="panelshow" runat="server">
        <div style="font-family: Tahoma; width: 780px; border: solid 1px #d7d4d4; margin-left: auto;
            ...
            <asp:GridView ID="gvDomains" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                AutoGenerateColumns="false" OnRowCommand="gvDomains_RowCommand" AllowPaging="True"
                OnPageIndexChanging="gvDomains_PageIndexChanging" PageIndex="10">
